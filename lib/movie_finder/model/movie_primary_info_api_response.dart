...
class MoviePrimaryInfoApiResponse {
  bool? adult;
  String? backdropPath;
  ...
  MoviePrimaryInfoApiResponse.fromJson(Map<String, dynamic> json) {
    adult = json['adult'];
...
class _BelongsToCollection {
  ...
  _BelongsToCollection.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    posterPath = json['poster_path'];
    backdropPath = json['backdrop_path'];
...
class _Genres {
  ...
  _Genres.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
  }
...
class _ProductionCompanies {
  ...
  _ProductionCompanies.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class _ProductionCountries {
  ...
  _ProductionCountries.fromJson(Map<String, dynamic> json) {
...
class _SpokenLanguages {
  ...
  _SpokenLanguages.fromJson(Map<String, dynamic> json) {
